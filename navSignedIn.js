            ...
            <div class="row menuAdjust">
                ...
                <div class="dropdown ">
                    ...
                    <ul class="dropdown-menu " role="menu " aria-labelledby="menu1 ">
                        <li role="presentation "><a role="menuitem " tabindex="-1 " class="text-reset " href="# ">Categories</a></li>
                        ...
                        <li role="presentation "><a role="menuitem " tabindex="-1 " class="text-reset " href="# ">Shop By Brand</a></li>
                    </ul>
                </div>
                <!-- Search Bar -->
                <!-- <div>
